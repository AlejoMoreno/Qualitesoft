<?php
	$ITReferencia=$_POST['ITReferencia'];
	$ITCumplimiento=$_POST['ITCumplimiento'];
	$ITRequerimiento=$_POST['ITRequerimiento'];
	$ITObservacion=$_POST['ITObservacion'];
	$ITTipo_programa=$_POST['ITTipo_programa'];
	$ITGuardar=$_POST['ITGuardar'];

	if(isset($_POST['ITGuardar'])) {
	...
	NULL, '$ITReferencia', '$ITRequerimiento', '$ITCumplimiento', '$ITObservacion', '$ITTipo_programa');";
