...
<body>
	<div id="bg">
		<div class="wrap">
			...
			<!-- logo -->
			<h1><a href="index.html">QualiteSoft</a></h1>
			<!-- /logo -->
			...
			<div id="mainmenu">
				<ul id="menu">
					...
					<li><a href="blog.html">Intranet</a></li>
			...
			<div id="main">
				<div id="intro">
					<h2>Bienvenido</h2>
					<p>Ut enim risus, rhoncus sit <a href="#">amet ultricies</a> vel, aliquet ut dolor. Duis iaculis urna vel massa ultricies suscipit. Phasellus diam sapien, fermentum a eleifend non, luctus non augue. Quisque <a href="#">scelerisque purus</a> quis eros sollicitudin gravida. Aliquam erat volutpat. Donec a sem consequat tortor posuere dignissim sit amet at ipsum.</p>
				</div>
			...
			<div id="side">
				<h4></h4>
				<!-- Este es el div de ingreso de usuario y contraseña. Se usa php para enviar los datos en este punto. -->
				<div class="Ingreso">
					<?php
					echo "Bienvenido";
				...
				<div class="news">
					...
					<p>Nunc commodo euismod ma
						include("php/index.php");ssa quis vestibulum, proin mi nibh, dignissim.</p>
				</div>
		...
		<div id="footer">
			<div id="footerbg">
				<div class="wrap">
					...
					<!-- footer links -->
					<p id="footer_menu">
						<a href="#">Job @ingenium</a>
						<a href="#">Press Releases</a>
						<a href="#">Terms and Conditions</a>

						<!-- credit link -->
						<a href="http://www.solucija.com" title="Free CSS Templates">Template from Solucija</a>
					</p>
					<!-- /footer links -->
